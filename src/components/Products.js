  ...
  if (category === undefined) {
    return (
      <div className="container">
        <Product
          item={data.fashion.items}
          title={data.fashion.title}
          name={data.fashion.name}
          amount={data.fashion.amount}
        />
        <Product
          item={data.accessory.items}
          title={data.accessory.title}
          name={data.accessory.name}
          amount={data.accessory.amount}
        />
        <Product
          item={data.digital.items}
          title={data.digital.title}
          name={data.digital.name}
