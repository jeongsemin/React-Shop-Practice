      ...
      <div className={styles.container}>
        ...
        {UserCart.noCart && (
          <div className={styles.noCartInfo}>
            ...
            <button className={styles.noCartButton} onClick={onclickHome}>
              담으러 가기
            </button>
          </div>
        )}
          ...
          return (
            <div className={styles.cartInfo}>
              ...
              <div className={styles.name}>
                <span className={styles.title} onClick={() => details(item.id)}>
                  {item.title}
                </span>
        ...
        <div className={styles.cartPrice}>
          ...
          <button className={styles.buyButton} onClick={UserCart.buyCart}>
            구매하기
          </button>
        </div>
      </div>
